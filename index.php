                        ...
                        <div class="col-12 col-md-6 d-flex flex-column justify-content-center text-white">
                            ...
                            <div class="">
                                ...
                                <p class=" text-justify">Somos Agency Fee, una empresa 100% Americana y estamos
                                    ...
                                    por un equipo
                                    altamente
                                    especializado y en constante formacion que esta dispuesto siempre para apoyarte en
                                    todo
                                    lo
                                    que necesites.</p>
                            </div>
                            <div class="d-flex">
                                ...
                                <div class="px-3">
                                    <h6>Apoyamos a las agencias de viajes independientes en el área de consolidación
                                    </h6>
                                </div>
                            </div>
                            <div class="d-flex mt-3">
                                ...
                                <div class="px-3">
                                    <h6>
                                        Ofrecemos la posibilidad de simplicar el trabajo de los Agentes de Viajes al
                                        momento
                                        de
                                        efectuar
            ...
            <div class="container  p-4">
                <div class="text-center">
                    ...
                    <p class="text-muted"> Te ofrecemos la oportunidad de ser parte de nuestro negocio, con<span
                            class="text-primary"> actractivos beneficios y licencia gratuita.</span>
                    </p>
                </div>
